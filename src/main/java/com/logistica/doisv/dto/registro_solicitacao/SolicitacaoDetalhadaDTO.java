...
public record SolicitacaoDetalhadaDTO(Long id, String tipo, Double quantidade, String motivo, String dataSolicitacao,
                                      String dataAtualizacao, String statusSolicitacao, String status,
                                      VendaSolicitacaoDTO venda, ConsumidorDTO consumidor,
                                      ProdutoSolicitacaoDTO produto, List<String> anexos, List<HistoricoSolicitacaoDTO> historico) {
    ...
    public SolicitacaoDetalhadaDTO(Solicitacao solicitacao) {
        this(solicitacao.getId(),
                ...
                solicitacao.getDataAtualizacao() != null ? solicitacao.getDataAtualizacao().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm")) : null,
