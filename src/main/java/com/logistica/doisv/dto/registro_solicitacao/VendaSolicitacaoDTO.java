...
public record VendaSolicitacaoDTO(Long idVenda, String serial, BigDecimal precoTotal, String statusPedido, BigDecimal desconto,
                                  String formaPagamento, Integer prazoTroca, Integer prazoDevolucao,
                                  String dataCriacao, String dataEntrega) {
